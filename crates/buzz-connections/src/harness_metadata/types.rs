...
pub static GOOSE_EFFORT_NORMALIZATION: EffortNormalization = EffortNormalization {
...
pub static BUZZ_AGENT_EFFORT_VALUES: &[&str] =
...
pub struct KnownAcpRuntime {
    ...
    /// Default ACP-mode arguments shared by Desktop and host launchers.
...
#[cfg(test)]
mod tests {
    use super::super::by_id as known_acp_runtime_exact;
